/*
This is a C++ header file used to separate the declaration of a class 
and its methods and attributes from its definition. This helps to 
improve the readability and the reusability of the code.
